...
map<string,map<string,map<string,int> > > myDict;  /*for now just store the id of doc and tf  in which this word is*/
...
//        cout<<"hello "<<tagName<<endl;
    ...
    if(!tagName.compare("page")){
        ...
        map<string,map<string,map<string,int> > >::iterator it;
            ...
            for (it=myDict.begin(); it!=myDict.end(); ++it){
                ...
                for (it1=(it->second).begin(); it1!=(it->second).end(); ++it1){
                    ...
                    for (it2=(it1->second).begin(); it2!=(it1->second).end(); ++it2){
                        indexfile<<it2->first<<'-'<<it2->second<<",";
                    }
                    indexfile<<'}';
                }
                indexfile<<endl;
